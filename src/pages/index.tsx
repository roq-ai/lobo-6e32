  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to lobo - Your global marketplace for buying and selling products. Connect, chat, and trade with ease, no matter where you are in the world."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to lobo - Your global marketplace for buying and selling products. Connect, chat, and trade with ease, no matter where you are in the world.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1556155092-8707de31f9c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMkNjaGF0fGVufDB8fHx8MTY4Nzk2MDYyMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
